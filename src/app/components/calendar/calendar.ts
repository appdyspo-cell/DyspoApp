        ...
        <div
          *ngFor="let displayEvent of day.events"
          ...
          [ngStyle]="{
            ...
            width:
              100 * (displayEvent.endIndex - displayEvent.startIndex) + '%',
            height: '25px'
          }"
        >
          <ng-template
        ...
        <div
          *ngFor="let displayEvent of tm.events"
          ...
          [ngStyle]="{
            ...
            left:
              (100 / displayEvent.overlapNumber) * displayEvent.position + '%',
      ...
      <dayview
        *ngSwitchCase="'day'"
        ...
        [dayviewNormalEventSectionTemplate]="
          dayviewNormalEventSectionTemplate || defaultNormalEventSectionTemplate
        "
